...
export default function Post(props) {
  return props.editing && props.editing._id === props.post._id ? (
      ...
      <form onSubmit={event => props.handleUpdate(event, props.post)}>
        ...
        <label className="w-100">
          ...
          <textarea
            ...
            defaultValue={props.editing.content}
            onChange={props.handleChange}
          />
        </label>
        <div style={styles.flexed} className="">
          <a href="#!" className="" onClick={e => props.handleCancel(e)}>
            cancel
          </a>
    ...
    <li className="black-text collection-item avatar">
      ...
      <div className="secondary-content">
        <a href="#!" className="" onClick={() => props.handleEdit(props.post)}>
          <i className="material-icons teal-text">edit</i>
        </a>
        <a
          href="#!"
          className=""
          onClick={() => props.handleDelete(props.post._id)}
        >
